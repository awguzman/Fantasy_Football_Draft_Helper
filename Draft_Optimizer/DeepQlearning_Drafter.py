...
class QAgent:
    ...
    def __init__(self, team_id, state_size, action_size, hidden_layers, position_limits, learning_rate=5e-3,
        ...
        self.scheduler = StepLR(self.optimizer, step_size=2000, gamma=0.25)  # Reduce LR by a factor of 0.5 every 500 steps.
...
class FantasyDraft:
    ...
    def __init__(self, player_data, num_teams, num_rounds, state_size, action_size, hidden_layers, position_limits):
        ...
        # Setup replay buffer.
        self.batch_size = 120
        self.replay_buffer = ReplayBuffer(capacity=1200)  # Shared replay buffer
