# A draft board creater for my best ball fantasy football league using data from the 2024 season.
...
# Scrape Fantasy Pro's 2023 projected player stats and store in DataFrames according to position.
...
# Scrape Fantasy Pro's 2023 Average Draft Position (ADP) data and store in a DataFrames according to position.
...
adp_df = adp_df.rename({'Player Team': 'Player', 'Rank': 'ADP'}, axis=1)
...
board_df.to_csv('2024_Best_Ball_Draft_Board.csv')